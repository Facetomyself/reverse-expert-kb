...
- 2026-06-25: OpenClaw web login approvals for a new Mac/browser are **device pairing**, not node pairing. Do not rely on `nodes` tool / `openclaw nodes ...` for this; those can show an empty or wrong view. First use `openclaw devices list`, `openclaw devices approve --latest`, or `openclaw devices approve <requestId>`. Diagnostic files are `~/.openclaw/devices/pending.json` and `~/.openclaw/devices/paired.json`, but if the CLI says `unknown requestId` or no pending requests while `pending.json` still has an entry, treat the file entry as stale and ask the user to re-trigger browser pairing rather than hand-editing auth state.

## Promoted From Short-Term Memory (2026-07-07)

<!-- openclaw-memory-promotion:memory:memory/2026-06-30.md:15:15 -->
- All 5 hosts reachable. No anomalies. [score=0.926 recalls=0 avg=0.620 source=memory/2026-06-30.md:15-15]
<!-- openclaw-memory-promotion:memory:memory/2026-06-30.md:17:20 -->
- | Host | Disk | Mem | Uptime | Containers | Status | |------|------|-----|--------|------------|--------| | oracle-proxy | 44% (26G) | 3.4G/11G | 77d | 14 all up | ✅ healthy | | oracle-gateway | 34% (31G) | 227M/952M | 53d | 1 (hysteria) | ✅ healthy | [score=0.926 recalls=0 avg=0.620 source=memory/2026-06-30.md:17-20]
<!-- openclaw-memory-promotion:memory:memory/2026-06-30.md:21:23 -->
- | oracle-mail | 60% (15G) | 1.2G/5.5G | 77d | 4 all up | ⚠️ moderate disk | | oracle-newapi-primary | 9% (89G) | 707M/11G | 57d | 1 (healthy) | ✅ excellent | | oracle-newapi-standby | 26% (72G) | 928M/11G | 57d | 1 (healthy) | ✅ healthy | [score=0.926 recalls=0 avg=0.620 source=memory/2026-06-30.md:21-23]
