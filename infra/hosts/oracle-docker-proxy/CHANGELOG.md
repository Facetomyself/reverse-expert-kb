...
- 2026-03-25: Per user direction, historical mixed runtime residue was cleaned up so this host can be observed as a focused gateway. Stopped legacy registry containers were removed; old registry files were archived to `/root/retired-services/2026-03-25-oracle-gateway-cleanup/registry-proxy` instead of being left in the live runtime surface.
