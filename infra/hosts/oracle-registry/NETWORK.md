...
- UDP `443` is also open as part of the current HTTPS front door shape, which is consistent with Caddy/HTTP3 rather than a separate application listener
