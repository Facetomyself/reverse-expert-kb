...
- recurring 2026-04-08 check also found a live additional listener on `*:9527` owned by `r_client`; this should currently be treated as observed runtime residue / drift rather than part of the actively maintained `Outlook Email Plus` role unless explicitly brought back into scope
