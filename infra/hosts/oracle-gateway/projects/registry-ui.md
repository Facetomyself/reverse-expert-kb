...
## 8. Current status
As of 2026-03-17:
- the component is considered deprecated / deleted due to host capacity constraints
- absence from runtime should not be treated as a break/failure of an intended active service
- any lingering Caddy route or stale note should be cleaned as documentation/runtime follow-up, not incident response
