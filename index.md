...
- native desktop/server practical workflows, now including a thinner GUI continuation around per-window subclass identity, Qt event-filter fate versus later handler/slot ownership, and the rule that application-global GUI hooks are usually reduction boundaries rather than automatic first-consumer proof
